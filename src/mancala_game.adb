package body Mancala_Game is
   ...
   begin
      return
        Get_Player_One_Live_Pebbles (Game) = 0 or
        Get_Player_Two_Live_Pebbles (Game) = 0;
   end Is_Finished;
   ...
   is
   begin
      if Is_Player_One (Game) and Current_Position in 0 .. 5 and
        Game.Board (Current_Position) = 1
      then
         Capture_From_Position_To_Mancala (Game, Current_Position, 6);
      elsif Is_Player_Two (Game) and Current_Position in 7 .. 12 and
        Game.Board (Current_Position) = 1
      then
   ...
   begin
      Game.Board (Mancala)                           :=
        Game.Board (Mancala) + Game.Board (Current_Position) +
   ...
   is
   begin
      if (Is_Player_One (Game) and Current_Position /= 6) or
        (Is_Player_Two (Game) and Current_Position /= 13)
      then
   ...
   begin
      return
        (Is_Player_One (Game) and Current_Position in 0 .. 5) or
        (Is_Player_Two (Game) and Current_Position in 7 .. 12);
